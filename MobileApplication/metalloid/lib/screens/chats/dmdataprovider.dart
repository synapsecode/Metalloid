class ChatModel {
  ...
  void addChat(String name, String message, String time, String avatarUrl){
    data.add(new ChatModel(name: name, message: message, time: time, avatarUrl: avatarUrl));
  }
}
...
List<ChatModel> data = [
  ...
  new ChatModel(
      ...
      time: "3:41 p.m",
      avatarUrl:
          "http://assets.blabbermouth.net/media/shawnclowncrahanslipknotdevil_638.jpg"),
  new ChatModel(
      name: "Matthew Tuck",
      message: "Sample Message",
      time: "3:41 p.m",
  ...
  new ChatModel(
      ...
      time: "3:00 p.m",
      avatarUrl:
          "http://assets.blabbermouth.net/media/joeyjordisonvimic2017_638.jpg"),
];
