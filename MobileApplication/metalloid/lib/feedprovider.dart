...
List<ImageItem> images = [
  ...
  ImageItem(
    ...
    author: authors[3],
    imageUrl: "https://consequenceofsound.net/wp-content/uploads/2015/03/system-of-a-down.jpg?quality=80&w=807"
  ),
  ImageItem(
    text: "Lamb Of God",
    author: authors[0],
    imageUrl: "https://townsquare.media/site/366/files/2014/11/Lamb-of-God.jpg"
  ),
  ImageItem(
    text: "Cannibal Corpse",
    author: authors[2],
    imageUrl: "http://s3.amazonaws.com/quietus_production/images/articles/8231/CannibalCorpse_brick2_Main-Promo_byAlexMorgan_1331641840_crop_558x350.jpg"
  ),
  ImageItem(
    text: "WhiteChapel",
    author: authors[0],
    imageUrl: "https://i.axs.com/2019/01/whitechapel-dying-fetus-tickets_04-24-19_17_5c3ca0b557f2b.jpg"
  ),
  ImageItem(
    text: "Linkin Park",
    author: authors[3],
    imageUrl: "https://www.billboard.com/files/styles/article_main_image/public/stylus/1004339-Linkin-Park-617.jpg"
  ),
];
